    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修设施" prop="ruzhudengjiName">
                       <el-input v-model="ruleForm.ruzhudengjiName"
                                 placeholder="维修设施" clearable  :readonly="ro.ruzhudengjiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="维修设施" prop="ruzhudengjiName">
                           <el-input v-model="ruleForm.ruzhudengjiName"
                                     placeholder="维修设施" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="设施类型" prop="guzhangweixiuTypes">
                        <el-select v-model="ruleForm.guzhangweixiuTypes" :disabled="ro.guzhangweixiuTypes" placeholder="请选择设施类型">
                            <el-option
                                v-for="(item,index) in guzhangweixiuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="设施类型" prop="guzhangweixiuValue">
                        <el-input v-model="ruleForm.guzhangweixiuValue"
                            placeholder="设施类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详细地址" prop="ruzhudengjiText">
                        <el-input type="textarea"  :readonly="ro.ruzhudengjiText" v-model="ruleForm.ruzhudengjiText" placeholder="详细地址"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.ruzhudengjiText" label="详细地址" prop="ruzhudengjiText">
                            <span v-html="ruleForm.ruzhudengjiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   ruzhudengjiName: [
                              { required: true, message: '维修设施不能为空', trigger: 'blur' },
                          ],
                   guzhangweixiuTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=guzhangweixiu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.guzhangweixiuTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=guzhangweixiu_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.guzhangweixiuYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`guzhangweixiu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.guzhangweixiuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
